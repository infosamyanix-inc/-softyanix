...
export const servicesDetailed = [
  {
    ...
    pricing: "Custom startup pricing tailored to project scope",
    timeline: "4-12 weeks",
    popular: true,
  },
  {
    ...
    pricing: "Flexible pricing and fast turnaround for startups",
    timeline: "3-8 weeks",
    popular: false,
  },
  {
    ...
    pricing: "Scalable mobile app pricing for growing teams",
    timeline: "6-16 weeks",
    popular: false,
  },
  {
    ...
    pricing: "Brand and product design packages for startups",
    timeline: "2-6 weeks",
    popular: false,
  },
  {
    ...
    pricing: "Custom API pricing for modern web platforms",
    timeline: "2-4 weeks",
    popular: false,
  },
  {
    ...
    pricing: "Flexible DevOps and cloud packages for startups",
    timeline: "1-3 weeks",
    popular: false,
  },
];

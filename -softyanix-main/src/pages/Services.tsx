  ...
  const services = [
    {
      ...
      pricing: "Custom pricing for startups and SMEs",
      timeline: "4-12 weeks",
      popular: true
    },
    {
      ...
      pricing: "Flexible startup packages tailored to your needs",
      timeline: "3-8 weeks"
    },
    {
      icon: Smartphone,
      ...
      pricing: "Tailored mobile app engagement plans for startups",
      timeline: "6-16 weeks"
    },
    {
      icon: Palette,
      ...
      pricing: "Startup-friendly UI/UX and branding packages",
      timeline: "2-6 weeks"
    },
    {
      icon: Database,
      ...
      pricing: "Custom API pricing matched to project scope",
      timeline: "2-4 weeks"
    },
    {
      icon: Cloud,
      ...
      pricing: "Flexible DevOps packages for growing startups",
      timeline: "1-3 weeks"
    }
  ];
